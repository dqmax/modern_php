...
<body>
    ...
    $backgroundImages = [
        ...
        'light rain shower' => 'images/stormy/bg.svg',
        'light drizzle' => 'images/stormy/bg.svg',
    ...
    if (isset($backgroundImages[$info->weatherType])) {
        $backgroundImage = $backgroundImages[$info->weatherType];
    }

    $weatherImages = [
        'stormy' => 'images/stormy/large.svg',
        'light rain shower' => 'images/stormy/large.svg',
        'light drizzle' => 'images/stormy/large.svg',
    ...
    $weatherImage = null;
    if (isset($weatherImages[$info->weatherType])) {
        $weatherImage = $weatherImages[$info->weatherType];
    }

    ?>  
    <div class="links">
        <a href="index.php?city='Bucharest'">Bucharest</a>
        <a href="index.php?city='London'">London</a>
        <a href="index.php?city='Tempe'">Tempe</a>
    </div>
        ...
        <div class="top-bar">
            ...
            <div class="top-bar__date">
                <?php echo date("F, j")?><sup>th</sup> <!-- Monday 25 -->
            </div>
        </div>
        <div class="weather-info">
            <img class="weather-info__image" 
                <?php if(!empty($weatherImage) && in_array($weatherImage, $weatherImages)): ?>
                    src="<?= $weatherImage ?>" alt="<?= $info->weatherType ?>" 
                <?php else: ?>
                    src="images/sunny/large.svg" alt="<?= $info->weatherType ?>" 
                <?php endif;?>
            />
            <h1 class="weather-info__temperature"><?= $info->temperatureK /* - 273.1 */ ?>°</h1> <!-- temperature 40 -->
            <p class="weather-info__desc">
            <?php if ($info->weatherType == 'stormy' || $info->weatherType == 'light rain shower' || $info->weatherType == 'light drizzle'): ?>
            ...
            <?php elseif ($info->weatherType == 'cloudy'): ?>
                ...
                Cloudy
            <?php elseif ($info->weatherType == 'sunny' || $info->weatherType == 'clear'): ?>
